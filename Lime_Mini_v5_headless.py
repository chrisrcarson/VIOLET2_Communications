...
class Lime_Mini_v5_headless(gr.top_block):
    ...
    def __init__(self, baud_rate=1200, dl_freq=145.91e6, rx_gain=56, sps=160, tx_gain=56, ul_freq=436830000):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, "os.path.join(os.path.dirname(os.path.abspath(__file__)), 'tx_fin_bits.hex')", False)
    ...
    def set_ul_freq(self, ul_freq):
        self.ul_freq = ul_freq
        self.limesdr_source_0.set_center_freq(self.ul_freq, 0)
