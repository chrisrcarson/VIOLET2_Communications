...
class Lime_Mini(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, baud_rate=1200, dl_freq=145.91e6, rx_gain=56, sps=160, tx_gain=56, ul_freq=436830000):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lime_Mini")
        ...
        self.limesdr_source_0 = limesdr.source('1D7522AE31A162', 0, '')
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/eceuser/CubeSat-NB/VIOLET2_Communications/FSK/tx_bits.hex', False)
        ...
        self.analog_quadrature_demod_cf_0 = analog.quadrature_demod_cf(192000/(2*math.pi*3500))
        self.analog_frequency_modulator_fc_0 = analog.frequency_modulator_fc(2.0*3.14159*3500.0/float(samp_rate))
        self.analog_agc_xx_0 = analog.agc_cc(1e-6, 1.0, 1.0)
...
def main(top_block_cls=Lime_Mini, options=None):
    if options is None:
