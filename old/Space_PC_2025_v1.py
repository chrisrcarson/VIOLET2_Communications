...
class Space_PC_2025_v1(gr.top_block, Qt.QWidget):

    def __init__(self, baud_rate=9600, dl_freq=436.83e6, rx_gain=30, sps=20, tx_gain=56, ul_freq=145.91e6):
        gr.top_block.__init__(self, "LimeSDR Space Software")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LimeSDR Space Software")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Space_PC_2025_v1")
...
def argument_parser():
    ...
    parser.add_argument(
        "--dl-freq", dest="dl_freq", type=eng_float, default="436.83M",
        help="Set DL_Freq [default=%(default)r]")
    parser.add_argument(
        "--sps", dest="sps", type=intx, default=20,
        help="Set sps [default=%(default)r]")
    parser.add_argument(
        "--ul-freq", dest="ul_freq", type=eng_float, default="145.91M",
        help="Set UL_Freq [default=%(default)r]")
    return parser


def main(top_block_cls=Space_PC_2025_v1, options=None):
    if options is None:
