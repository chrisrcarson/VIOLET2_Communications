...
class Lime_Mini_v4(gr.top_block, Qt.QWidget):

    def __init__(self, baud_rate=1200, dl_freq=145.91e6, rx_gain=56, sps=160, tx_gain=56, ul_freq=436830000):
        gr.top_block.__init__(self, "TRXVU LimeSDR Ground Software", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lime_Mini_v4")
        ...
        self._tx_gain_ui_range = qtgui.Range(0, 60, 1, tx_gain, 200)
        self._tx_gain_ui_win = qtgui.RangeWidget(self._tx_gain_ui_range, self.set_tx_gain_ui, "Transmit Gain (dB)", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._tx_gain_ui_win)
        ...
        self._ul_freq_ui_line_edit.editingFinished.connect(
            lambda: self.set_ul_freq_ui(eng_notation.str_to_num(str(self._ul_freq_ui_line_edit.text()))))
        self.top_layout.addWidget(self._ul_freq_ui_tool_bar)
        self._squelch_ui_range = qtgui.Range(-70, -30, 1, -50, 200)
        self._squelch_ui_win = qtgui.RangeWidget(self._squelch_ui_range, self.set_squelch_ui, "squelch", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._squelch_ui_win)
        self._rx_gain_ui_range = qtgui.Range(0, 60, 1, rx_gain, 200)
        self._rx_gain_ui_win = qtgui.RangeWidget(self._rx_gain_ui_range, self.set_rx_gain_ui, "Recieve Gain (dB)", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._rx_gain_ui_win)
        ...
        self.limesdr_source_0.set_center_freq(ul_freq, 0)
        ...
        self._dl_freq_ui_line_edit.editingFinished.connect(
            lambda: self.set_dl_freq_ui(eng_notation.str_to_num(str(self._dl_freq_ui_line_edit.text()))))
        self.top_layout.addWidget(self._dl_freq_ui_tool_bar)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/eceuser/CubeSat-NB/VIOLET2_Communications/FSK_Working/tx_fin_bits.hex', False)
    ...
    def set_baud_rate(self, baud_rate):
        ...
        self.root_raised_cosine_filter_1.set_taps(firdes.root_raised_cosine(1, (self.sps*self.baud_rate), (2*self.baud_rate), 0.35, (self.sps*7)))
    ...
    def set_ul_freq(self, ul_freq):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.ul_freq, 10000)
...
def main(top_block_cls=Lime_Mini_v4, options=None):
    if options is None:
